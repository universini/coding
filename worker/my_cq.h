 ...
 * my_cq_is_empty
 */
#define my_cq_is_empty(h)                  \
    ((h)->qnext == (h))

/*
 * my_cq_ent_on_q
 */
#define my_cq_ent_on_q(e, f)                \
    ((e)->f.qnext != &(e)->f)               \

/*
 * my_cq_ent
 */
#define my_cq_ent(h, t, f)                  \
    (t *)((char *)&((h)->qnext) -           \
          (char *)&((t *)0)->f)
 ...
 * my_cq_first
 */
#define my_cq_first(h, t, f)                \
    (my_cq_ent((h)->qnext, t, f))
 ...
 * my_cq_next
 */
#define my_cq_next(e, t, f)                 \
    (my_cq_ent((e)->f.qnext, t, f))
